...
=head1 FuseGen
  ...
  &eFunc::FuseGen("json_file", "template_file");
...
sub FuseGen {
	...
	my $tmpl_file = "$main::HDLGEN_ROOT/plugins/Design_Template/Fuse.tmpl.v";
   	if (!(-e $tmpl_file)) {
   		die " !!!ERROR!!!: your FuseGen design template does NOT existe!\n";
   	}
