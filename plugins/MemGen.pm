...
=head1 MemGen
  ...
  &eFunc::MemGen("json_file", "template_file");
...
sub MemGen {
	...
	my $tmpl_file = "$main::HDLGEN_ROOT/plugins/Design_Template/Mem.tmpl.v";
   	if (!(-e $tmpl_file)) {
   		die " !!!ERROR!!!: your MemGen design template does NOT existe!\n";
   	}
